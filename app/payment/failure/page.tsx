    ...
    try {
      ...
      if (externalReference) {
        ...
        if (!querySnapshot.empty) {
          ...
          // Actualizar estado de la venta a rechazada
      ...
      <div className="container mx-auto px-4 py-16">
        <Card className="max-w-md mx-auto bg-white">
          <CardContent className="p-8 text-center">
            ...
            <h1 className="text-2xl font-bold text-black mb-4">Pago Rechazado</h1>
            <p className="text-gray-600 mb-6">
              Tu pago no pudo ser procesado. Esto puede deberse a fondos insuficientes, datos incorrectos o problemas con tu tarjeta.
            </p>
            
            <div className="bg-gray-50 p-4 rounded-lg mb-6 text-left">
              <h3 className="font-semibold text-black mb-2">¿Qué puedes hacer?</h3>
            ...
            <div className="space-y-3">
              <Button asChild className="w-full bg-black text-white hover:bg-gray-800">
                <Link href="/carrito">Intentar Nuevamente</Link>
              </Button>
